...
$(document).ready(function () {
  ...
  var a =
      ...
      graphs: [
        {
          ...
          balloonText:
            "[[title]]<br /><b style='font-size: 130%'>$[[value]]M</b>"
        },
        {
          id: 'g4',
          valueAxis: 'v1',
    ...
    document.getElementById('newuserchart').getContext('2d'))//cores do gráfico
  window.myDoughnut = new Chart(a, {
    type: 'doughnut',
    data: {
      datasets: [
        {//variáveis do gráfico
          data: [cadastros, aprovados, docs],
          backgroundColor: [cor_cadastros, cor_aprovados, cor_docs],
          label: 'Dataset 1'
        }
      ],
      labels: [label_cadastros, label_aprovados, label_docs]
    },
    options: {
